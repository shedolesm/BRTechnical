...
for div in soup.find_all('div', {'class':'a-section a-spacing-medium'}):
    productNameAll = div.find('span', {'class':'a-size-medium a-color-base a-text-normal'})
    price = div.find('span', {'class':'a-price-whole'})
    priceOfProduct= '0'
    productName = productNameAll.text
    priceOfProduct = price.text
    print(productName)
